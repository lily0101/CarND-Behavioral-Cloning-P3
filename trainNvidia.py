...
# -*- coding: utf-8 -*-
"""
Created on Mon Oct 23 15:51:26 2017
...
X_valid,y_valid = forValidData(validation_samples)
...
history_object = model.fit_generator(train_generator, steps_per_epoch = len(train_samples)/32, validation_data = (X_valid,y_valid), validation_steps = len(validation_samples)/32,epochs=5, verbose=1,callbacks=cbks)
